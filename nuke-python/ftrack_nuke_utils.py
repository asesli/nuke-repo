...
def open_in_projects(shot_id):
	url = "https://lux-visual-effects.ftrackapp.com/#entityId={}&entityType=task&itemId=projects&view=tasks".format(shot_id)
	go_to_url(url)

def open_in_dashboard(task_id):
	url = "https://lux-visual-effects.ftrackapp.com/#slideEntityId={}&slideEntityType=task&itemId=home".format(task_id)
	go_to_url(url)
